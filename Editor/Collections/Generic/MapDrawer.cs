...
namespace Rebar.Unity.Collections.Editor
{
    [CustomPropertyDrawer(typeof(Rebar.Unity.Collections.Generic.Map<,>), true)]
    public class MapDrawer : UnityEditor.PropertyDrawer
    {
        ...
        private ReorderableList RetrieveList(SerializedProperty property, GUIContent label) {
            if (_list == null) {
                ...
                _list.elementHeightCallback = index => 
                        EditorGUI.GetPropertyHeight(_list.serializedProperty.GetArrayElementAtIndex(index));
        ...
        public override float GetPropertyHeight(SerializedProperty property, GUIContent label)
        {
            ...
            // Foldout height;
            totHeight += EditorGUIUtility.singleLineHeight;
